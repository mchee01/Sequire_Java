...
public class A04DataCasting {
	...
	public static void main(String[] args) {
		...
		System.out.println("정수 형식 평균 :" + avgInt);  //80
		System.out.println("실수 형식 평균 :" + avgDouble);
		
		// sum 또는 count 중 하나를 실수 형식으로 바꾸어서 나눗셈을 하면 결과가 80.5 가 나옵니다.
		avgDouble = (double)sum/count; 			//2)sum을 강제로 변환(캐스팅) - 1)번과의 차이점.
 ...
 * 1	  2		  4		8	   4		  8          바이트	 		
 * 
 * char 문자형을 코드값 구하기 위해 정수로 캐스팅할 때에는 0~65535 를 충분히 저장할 수 있는
 * int 정수형으로 캐스팅합니다.
 */