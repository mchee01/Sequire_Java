 ...
 *          ㄴ import 를 통해서 이 프로그램에서 사용할 클래스를 메모리 올립니다.
...
public class B08MathTest {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(" 3개의 정수 34 ,56, 12 의 최대값 = " + Math.max(Math.max(34,56),12));
        System.out.println(" 3개의 정수 34 ,56, 12 의 최소값 = " + Math.min(Math.min(34,56),12));
