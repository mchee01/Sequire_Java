...
public class B14ObjectTest {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("\t ob2 hashcode =" 
                    + ob1.hashCode() + "," + Integer.toHexString(ob2.hashCode()));
        System.out.println("\t ob3 hashcode =" 
                    + ob1.hashCode() + "," + Integer.toHexString(ob3.hashCode()));                    
        ...
        System.out.println("\t ob3 toString = " + ob3.toString());      //Integr는 toString 재정의
